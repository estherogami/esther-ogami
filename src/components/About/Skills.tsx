...
const Skills = () => {
    ...
    const desText: ISubLanguage = {
        en: " <h4>Graphic Design</h4> <p>While my primary focus is web development, my experience extends to the field of graphic design. <br />I have proficiency in <strong>Adobe Photoshop</strong>, <strong>Adobe Illustrator</strong>, and <strong>Adobe XD</strong> as my design tools.</p>",
